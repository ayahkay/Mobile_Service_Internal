...
class Homepage:
    """
A class to represent the homepage.
...
- To view your job history, press 'Show All Jobs'.""",
        ...
        def configure():
            """
Enable minutes spent entry.

Enables minutes spent entry based on the selection of checkbox.
If the checkbox isn't selected, then the entry will be disabled.
Once the checkbox is selected, the entry will enable (return to a "normal" state).
"""
    ...
    def calc_charge(self):
        """
Calculate the job's charge.

Takes the input given over the course of the program and calculates
the overall job cost based on Suzy's rates. Returns a different label
...
---------
label : str
    The outcome of the calculation (error message or overall cost) 
"""
...
class AllJobs:
    """
A class to represent the All Jobs page.

This displays all the jobs Suzy has entered, one job at a time.
When the Previous Job button is clicked, it displays the previous job.
When the Previous Job button is clicked, it displays the previous job.

Accepts
------
total_jobs_list : list
"""
...
- To see the next job you entered, press 'Next Job'.""",
    ...
    def previous_job(self, total_jobs_list):
        """
Change the job displayed.

Displays the previous job when the button is pressed.
...
---------
label : str
    The previous job (displayed as a label)
"""
        self.i -= 1
...
Displays the next job when the button is pressed.
...
---------
label : str
    The next job (displayed as a label)
"""
        self.i += 1
        self.display_history_label.config(text = total_jobs_list[self.i] + "\n")
        self.check_button(total_jobs_list)
...
Disables Previous Job button when the first job is displayed.
Disables Next Job button when the last job is displayed.
